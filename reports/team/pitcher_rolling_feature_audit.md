...
| **Total Sourced Prior-Season Fallback Events** | 3,779 |
| **Fallback Sourcing Rate** | 5.06% |
...
| `home_prior_starts_count` | Number of prior starts in current season (provenance audit) | 0.00% |
